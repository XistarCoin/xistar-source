...
In order to support loading of multiple wallets in xistar-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is xistar.cpp.
...
Changes to xistar.cpp
----------------------
xistar.cpp is the entry point into xistar-qt, and as such, will require some minor modifications to provide hooks for
