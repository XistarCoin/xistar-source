...
#   c) node1 mines 32 blocks, so now node 0 has 60001xis, node 1 has 4250xis, node2 has none.
#   d) node0 sends 601 xis to node2, in two transactions (301 xis, then 300 xis).
