...
#ifndef Xistar_STAKEINPUT_H
#define Xistar_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZXIS() = 0;
    virtual CDataStream GetUniqueness() = 0;
};


// zXISStake can take two forms
// 1) the stake candidate, which is a zcmint that is attempted to be staked
// 2) a staked zxis, which is a zcspend that has successfully staked
...
public:
    ...
    bool IsZXIS() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZXIS() override { return false; }
};


#endif //Xistar_STAKEINPUT_H
