...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Xistar features */
        {"xistar", "masternode", &masternode, true, true, false},
        {"xistar", "listmasternodes", &listmasternodes, true, true, false},
        {"xistar", "getmasternodecount", &getmasternodecount, true, true, false},
        {"xistar", "masternodeconnect", &masternodeconnect, true, true, false},
        {"xistar", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"xistar", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"xistar", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"xistar", "masternodecurrent", &masternodecurrent, true, true, false},
        {"xistar", "masternodedebug", &masternodedebug, true, true, false},
        {"xistar", "startmasternode", &startmasternode, true, true, false},
        {"xistar", "createmasternodekey", &createmasternodekey, true, true, false},
        {"xistar", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"xistar", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"xistar", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"xistar", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"xistar", "getmasternodescores", &getmasternodescores, true, true, false},
        {"xistar", "mnbudget", &mnbudget, true, true, false},
        {"xistar", "preparebudget", &preparebudget, true, true, false},
        {"xistar", "submitbudget", &submitbudget, true, true, false},
        {"xistar", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"xistar", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"xistar", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"xistar", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"xistar", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"xistar", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"xistar", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"xistar", "checkbudgets", &checkbudgets, true, true, false},
        {"xistar", "mnsync", &mnsync, true, true, false},
        {"xistar", "spork", &spork, true, true, false},
        {"xistar", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzxisseed", &getzxisseed, false, false, true},
        {"zerocoin", "setzxisseed", &setzxisseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzxis", &searchdzxis, false, false, true},
        {"zerocoin", "dzxisstate", &dzxisstate, false, false, true}
...
{
    return "> xistar-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:6835/\n";
}
