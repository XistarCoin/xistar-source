...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Xistar Core xistar-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  xistar-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded xistar transaction") + "\n" +
                               "  xistar-tx [options] -create [commands]   " + _("Create hex-encoded xistar transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded xistar transaction
