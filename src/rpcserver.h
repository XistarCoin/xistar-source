...
extern UniValue setzxisseed(const UniValue& params, bool fHelp);
extern UniValue getzxisseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzxis(const UniValue& params, bool fHelp);
extern UniValue dzxisstate(const UniValue& params, bool fHelp);
