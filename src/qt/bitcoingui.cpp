                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Xistar Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Xistar address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and xistar: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zXIS"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Xistar Core"), this);
    aboutAction->setStatusTip(tr("Show information about Xistar Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Xistar"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Xistar addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Xistar addresses"));
    ...
    openAction->setStatusTip(tr("Open a Xistar: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Xistar Core help message to get a list with possible Xistar command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Xistar Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Xistar network", "", count));
}
...
{
    QString strTitle = tr("Xistar Core"); // default title
