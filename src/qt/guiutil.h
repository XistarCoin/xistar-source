...
/** Utility functions used by the Xistar Qt UI.
 */
namespace GUIUtil
{
...
// Render Xistar addresses in monospace font
...
// Parse "xistar:" URI into recipient object, return true on successful parsing
