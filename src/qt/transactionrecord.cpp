...
QList<TransactionRecord> TransactionRecord::decomposeTransaction(const CWallet* wallet, const CWalletTx& wtx)
{
    ...
    if (wtx.IsCoinStake()) {
        ...
        if (wtx.IsZerocoinSpend() && (fZSpendFromMe || wallet->zxisTracker->HasMintTx(hash))) {
            //zXIS stake reward
            sub.involvesWatchAddress = false;
            sub.type = TransactionRecord::StakeZXIS;
...
bool IsZXISType(TransactionRecord::Type type)
{
    switch (type) {
        case TransactionRecord::StakeZXIS:
...
void TransactionRecord::updateStatus(const CWalletTx& wtx)
{
    ...
    else if (type == TransactionRecord::Generated || type == TransactionRecord::StakeMint || type == TransactionRecord::StakeZXIS || type == TransactionRecord::MNReward) {
