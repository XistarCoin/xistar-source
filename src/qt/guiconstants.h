...
/* Xistar GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Xistar"
#define QAPP_ORG_DOMAIN "xistar.org"
#define QAPP_APP_NAME_DEFAULT "Xistar-Qt"
#define QAPP_APP_NAME_TESTNET "Xistar-Qt-testnet"
