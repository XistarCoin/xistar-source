                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzXISPathCustom = GetArg("-zxisbackuppath", "");
    ...
    if(!strzXISPathCustom.empty()) {
        ui->wallet_customzxisbackuppath->setText(QString::fromStdString(strzXISPathCustom));
        ui->wallet_customzxisbackuppath_label->setVisible(true);
        ui->wallet_customzxisbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzXISPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Xistar RPC console.") + "<br>" +
