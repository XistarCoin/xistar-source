...
RESOURCES += src/qt/xistar.qrc src/qt/xistar_locale.qrc

TRANSLATIONS += src/qt/locale/xistar_bg.ts \
                src/qt/locale/xistar_de.ts \
                src/qt/locale/xistar_en.ts \
                src/qt/locale/xistar_es.ts \
                src/qt/locale/xistar_fi.ts \
                src/qt/locale/xistar_fr.ts \
                src/qt/locale/xistar_it.ts \
                src/qt/locale/xistar_ja.ts \
                src/qt/locale/xistar_pl.ts \
                src/qt/locale/xistar_pt.ts \
                src/qt/locale/xistar_ru.ts \
                src/qt/locale/xistar_sk.ts \
                src/qt/locale/xistar_sv.ts \
                src/qt/locale/xistar_vi.ts \
                src/qt/locale/xistar_zh_CN.ts \
                src/qt/locale/xistar_zh_TW.ts
