Contributing to Xistar Core
============================

The Xistar Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Xistar Core project, and is not to be
confused with overall Xistar Network Protocol consensus changes.

Whether a pull request is merged into Xistar Core rests with the project merge
...
Patches that change Xistar consensus rules are considerably more involved than
...
Where a patch set proposes to change the Xistar consensus, it must have been
...
The project leader is the release manager for each Xistar Core release.
